...
<?php echo form_open('index.php/Autenticacao/registo')?>

<dl>
	<dt><?php echo form_label('Numero de utente', $username['id']);?></dt>
	<dd>
	...
	<dt><?php echo form_label('Endereço de Email', $email['id']);?></dt>
	<dd>
