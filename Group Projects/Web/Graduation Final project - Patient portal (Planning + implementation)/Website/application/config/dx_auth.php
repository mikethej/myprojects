...
$config['DX_website_name'] = 'Portal Saúde';
$config['DX_webmaster_email'] = 'geral_portalsaude@portalsaude.com';
...
$config['DX_activate_uri'] = 'index.php/Autenticacao/activate/';
...
// Forms view
$config['DX_login_view'] = 'index.php/Autenticacao/login';
$config['DX_register_view'] = 'index.php/Autenticacao/registo';
