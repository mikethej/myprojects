...
<head>
    ...
    <title>Politica Reembolso | Tuga-Buy</title>
...
<body>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">
	                <h2 class="title text-center">Política de Reembolso</h2>
                    <div id = "contactos">
                        <p>Não devolvemos nada, tivesse pensado 2 vezes antes de comprar</p>
                        <p>Mas se mesmo assim não está satisfeito, mostramos uma foto de uma batata para compensar</p>
                        <ul>
                              <li class = "fotos"><img src="images/batata.jpg" alt = "batata"/>
                        </ul>
                        <div id = "auto"></div>
                        <div id = "final"></div>
                        <script type="text/javascript">
