...
<head>
    ...
    <title>Developers | Tuga-Buy</title>
	...
	<header id="header"><!--header-->		
							...
							<ul class="nav navbar-nav">
								<?php
                                    if ($_COOKIE['login'] == 'true'){
                                        echo '<li><a href="items">Adicionar Item</a></li>';
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Criadores</h2>
                    <div id = "contactos">
                        <ul>
                              <li class = "fotos"><img src="images/Jorge.jpg" alt = "Ferras"/>
                                  <p>Jorge Ferreira</p>
                                  <p>43104</p></li>
                              <li class = "fotos"><img src="images/Bettina.jpg" alt = "Benuron"/>
                                  <p>Bettina Pedro</p>
                                  <p>44309</p></li>
                              <li class = "fotos"><img src="images/Filipa.jpg" alt = "Xanax"/>
                                  <p>Filipa Loureiro</p>
                                  <p>46586</p></li>
                        </ul>
                    </div>
                    <p>Jorge Ferreira: <br/>Aluno de Tecnologias de Informação</p>
                    <p>Bettina Pedro: <br/>Aluna de Tecnologias de Informação</p>
                    <p>Filipa Loureiro: <br/>Aluna de Tecnologias de Informação</p>
				</div>
                <div id = "auto"></div>
                <div id = "final"></div>
                <script type="text/javascript">
