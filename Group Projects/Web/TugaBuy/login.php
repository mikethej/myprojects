...
<head>
	...
	<title>Iniciar Sessão | Tuga-Buy</title>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<?php
                                if ($_COOKIE['login'] == 'true'){
                                    echo "<p>Já tens sessão iniciada</p>
                                    <p><a href='logout'>Termina sessão aqui</a></p>";
                                }
                                else{
                                    echo "<form id='login-form' action='loginsucesso' method='post' role='form' style='display: block;'>
									<div class='form-group'>
										<input type='text' name='nick' id='nick' tabindex='1' class='form-control' placeholder='Nickname/Email'>
									</div>
									<div class='form-group'>
									...
									<div class='form-group'>
										<div class='row'>
											<div class='col-sm-6 col-sm-offset-3'>
												<button type='submit' value='Submit' name='submit' class='btn btn-default' id='posicao'>Entrar</button>
											</div>
										</div>
									</div>
									<div class='form-group'>
										<div class='row'>
											<div class='col-lg-12'>
												...
												<br></br>
												<p id='alinhamento'>Ainda não criaste conta?
												<a href='register' id='criar'>Criar aqui</a>
                                                </p>
												</div>
											</div>
										</div>
