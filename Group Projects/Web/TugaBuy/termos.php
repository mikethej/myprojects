...
<head>
    ...
    <title>Termos de uso | Tuga-Buy</title>
        ...
        <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">
                    ...
                    <div id = "contactos">
                    	<p>O site pode ser usado como o utilizador quiser, desde que não seja para roubar contas e rebentar com a segunça do mesmo.</p>
                        <p>As seguintes funcionalidades são as que neste momento estão concluidas:</p>
                        <p>Interface</p>
                        <p>Login</p>
                        <p>Regitar</a>
				    </div>
