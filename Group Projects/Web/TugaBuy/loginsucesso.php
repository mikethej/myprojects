<?php
    ...
    if($nick&&$password){
        ...
        $query = "SELECT nick, email, pal_chave FROM utilizadores WHERE (nick = '$nick'  OR email = '$nick') AND pal_chave ='$password';";
        ...
        if ($numrows!= 0){
            ...
            die("Nick ou palavra-passe errados");
        }
    }
    else{
        die("Introduza o nick e password");
    }
    mysqli_close($conn);
?>
