...
<head>
    ...
    <title>Info sobre a companhia | Tuga-Buy</title>
...
<body>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">
	                <h2 class="title text-center">Info sobre a companhia</h2>
                    <div id = "contactos">
                        <p>Companhia criada em Fevereiro de 2016</p>
                        <p>O trabalho desenvolvido pela mesma é sempre com qualidade garantida</p>
                        <p>Esta companhia tem como exclusividade devenvolver projectos para a cadeira de ASW e para ser avaliada pelos seus professores</p>
				    </div>
                    <div id = "auto"></div>
                    <div id = "final"></div>
                    <script type="text/javascript">
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Info sobre a companhia</a></li>
