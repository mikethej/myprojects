...
<head>
    ...
    <title>Política de privacidade | Tuga-Buy</title>
...
<body>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">
	                <h2 class="title text-center">Política de Privacidade</h2>
                    <div id = "contactos">
                        <p>Todos os seus dados são devidamente protegidos</p>
                        <p>Só o próprio pode ver e alterar os seus próprios dados sendo que os outros utilizadores comuns não têm acesso a eles</p>
				    </div>
                    <div id = "auto"></div>
                    <div id = "final"></div>
                    <script type="text/javascript">
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="refundo.html">Política de Reembolso</a></li>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>Menu rápido</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><a href="shop.html">Roupa</a></li>
								<li><a href="shop.html">Tecnologia</a></li>
								<li><a href="shop.html">Casa</a></li>
                                <li><a href="shop.html">Acessórios</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>Sobre</h2>
							<ul class="nav nav-pills nav-stacked">
                                <li><a href="developers.html">Criadores</a></li>
								<li><a href="info.html">Info sobre a companhia</a></li>
								<li><a href="contact-us.html">Contactos e Localização</a></li>
							</ul>
						</div>
					</div>
				</div>
