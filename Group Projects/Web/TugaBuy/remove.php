...
<head>
    ...
    <title>Remover Artigo | Tuga-Buy</title>
...
<body>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">
	                <h2 class="title text-center">Remover Artigo</h2>
                    <div id = "contactos">
                        <p>Tem a certeza que pretende apagar o item?</p>
                        <form action="#" method="post">
                              <input type='submit' class='btn btn-fefault cart' name = "si" value="Sim">
                            <input type='submit' class='btn btn-fefault cart' name = "no" value="N&atilde;o"></span>
                        </form>
                        ...
                        <?php
                            ...
                            $no = $_POST['no'];
                            $si = $_POST['si'];
                            if ($si){ //Se o utilizador clicar em sim apaga o artigo da base de dados
                                $sql = "DELETE FROM artigos WHERE item_id='".$idi."';";
                                $query = mysqli_query($conn, $sql) or die("Error");
                                $sqli = "DELETE FROM palavraschave WHERE item_id='".$idi."';";
                                $queryi = mysqli_query($conn, $sqli) or die("Error");
                                echo "<script>document.getElementById('contactos').innerHTML='Produto eliminado';</script>"; //Apaga tudo da div e escreve Produto Eliminado
                            }
                            else{
                                if ($no){ //Se clicar nao vai para o index e nao apaga o artigo
